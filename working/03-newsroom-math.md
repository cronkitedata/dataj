...
* Integrate numbers into your reporting and writing
* Calculate change in a list of items
* Use different types of averages as summaries of a list of items.

While this chapter covers general tips, you can find specific instructions for typical newsroom math in this tipsheet LINK TK , and later chapters will include them while using a spreadsheet.  
...
Here's one example of putting huge numbers in perspective. Notice that the only number you really *see* in this paragraph is **$21.17**. 
...
> "[Buying Power](https://www.nytimes.com/interactive/2015/10/11/us/politics/2016-presidential-election-super-pac-donors.html)", Nicholas Confessore, Sarah Cohen and Karen Yourish, New York Times, October 2015

(I had originally written it a little differently, but editors objected: "That huge sum is the equivalent of a night out at Pizza Hut for the typical American family." )
...
By Matt Waite, University of Nebraska
